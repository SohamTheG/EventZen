...
export default function SignUp(props) {
  ...
  const validateInputs = () => {
    ...
    // Grab the value from the name attribute
  ...
  const handleSubmit = async (event) => {
    ...
    const signUpData = {
      ...
      role: data.get('role'), // This will now be 'user' or 'admin'
    };
      ...
      <SignUpContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          ...
          >
            ...
            {/* //Control for choosing role between customer and admin */}
            <FormControl error={roleError}>
              <FormLabel>Role</FormLabel>
              <RadioGroup
                row
                name="role" // This name is used to grab data in handleSubmit
                defaultValue="user"
              >
